    ...
    <section class="form-screen-transition mr-5 ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10 ">
                    <h1 class="text-center ml-4 mt-5">Frequently Asked Questions </h1>
                </div>
                <div class="row">
                    @if(session('success'))
            ...
            <div class="row">
                ...
                <div class="col-md-10 my-4 p-0">
                    <a href="/admin/faq/create" type="button" class="btn admin-form-button">New FAQ</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2" aria-hidden="true"></div>
                                            ...
                                            <span class="dropdown">
                                                <button class="btn dropdown-toggle align-text-top" data-bs-boundary="viewport" data-bs-toggle="dropdown">Actions</button>
                                                  <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('edit.faq', $faq->id) }}" aria-label="edit faq">
                                                      Edit
                                                    </a>

                                                    <a class="dropdown-item" href="{{ route('delete.faq', $faq->id) }}" onclick="if (!confirm('Are you sure you want to delete this FAQ?')) { return false }" aria-label="delete faq">
                                                      Delete
                                                    </a>
                                                  </div>
                                            </span>
