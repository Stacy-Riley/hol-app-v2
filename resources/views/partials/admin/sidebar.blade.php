    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                <li class="nav-item">
                    <a class="nav-link" href="/admin"  aria-label="go to main admin page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/book"  aria-label="go to book products index page" >
                      <span>
                        ...
                        <span class="pl-2">Book Products</span>
                      </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/businessPartner"  aria-label="go to book business partners index page" >
                      <span>
                        ...
                        <span class="pl-2">Business Partners</span>
                      </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/businessService"  aria-label="go to business services index page" >
                      <span>
                        ...
                        <span class="pl-2">Business Services</span>
                      </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/careerListing"  aria-label="go to career listings index page">
                      <span>
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-list"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 6l11 0" /><path d="M9 12l11 0" /><path d="M9 18l11 0" /><path d="M5 6l0 .01" /><path d="M5 12l0 .01" /><path d="M5 18l0 .01" /></svg>
                        <span class="pl-2">Career Listings</span>
                      </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/faq"  aria-label="go to frequently asked questions index page" >
                      <span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/admin/pressPost"  aria-label="go to press post index page" >
                      <span>
                        <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-article"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 4m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z" /><path d="M7 8h10" /><path d="M7 12h10" /><path d="M7 16h10" /></svg>
                        <span class="pl-2">Press Posts</span>
                      </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/admin/testimonial"  aria-label="go to testimonials index page" >
                        <span >
                            ...
                            <span class="pl-2">Testimonials</span>
                        </span>
                    </a>
                </li>
                <li class="text-center mb-3 mt-3">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="admin-logout-button px-3 py-1 border-0" type="submit" aria-label="sign out of admin panel, return to website">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-logout-2"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10 8v-2a2 2 0 0 1 2 -2h7a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-7a2 2 0 0 1 -2 -2v-2" /><path d="M15 12h-12l3 -3" /><path d="M6 15l-3 -3" /></svg> Sign Out
                        </button>
                    </form>
                </li>
            </ul>
