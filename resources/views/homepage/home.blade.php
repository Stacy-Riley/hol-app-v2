        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <img src="{{asset ('/assets/images/welcom_sign.png')}}" class="img-fluid" alt="welcom-img">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="courses_box mb-5">
                        <div class="course-img-wrap">
                            <img src="{{asset ('assets/images/courses_1.jpg')}}" class="img-fluid" alt="courses-img">
                        ...
                        <div class="courses_icon">
                            <img src="{{asset ('assets/images/plus-icon.png')}}" class="img-fluid close-icon" alt="plus-icon">
                        </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="courses_box mb-5">
                        <div class="course-img-wrap">
                            <img src="{{asset ('assets/images/courses_2.jpg')}}" class="img-fluid" alt="courses-img">
                            <div class="courses_box-img">
                                <div class="courses-link-wrap">
                                    <a href="course-detail.html" class="course-link"><span>course Details </span></a>
                                    <a href="admission-form.html" class="course-link"><span>Join today </span></a>
                        ...
                        <!-- // end .course-img-wrap -->
                        <div class="courses_icon">
                            <img src="assets/images/plus-icon.png" class="img-fluid close-icon" alt="plus-icon">
                        </div>
                        <a href="course-detail.html" class="course-box-content">
                            <h3>History</h3>
                            <p>When an unknown printer took a galley...</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="courses_box mb-5">
                        <div class="course-img-wrap">
                            <img src="assets/images/courses_3.jpg" class="img-fluid" alt="courses-img">
                            <div class="courses_box-img">
                                <div class="courses-link-wrap">
                                    <a href="course-detail.html" class="course-link"><span>course Details </span></a>
                                    <a href="admission-form.html" class="course-link"><span>Join today </span></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="courses_box mb-5">
                        <div class="course-img-wrap">
                            <img src="assets/images/courses_4.jpg" class="img-fluid" alt="courses-img">
                            <div class="courses_box-img">
                                <div class="courses-link-wrap">
                                    <a href="course-detail.html" class="course-link"><span>course Details </span></a>
                                    <a href="admission-form.html" class="course-link"><span>Join today </span></a>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="event-img">
                        ...
                        <img src="assets/images/upcoming-event-img.jpg" class="img-fluid" alt="event-img">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom">
                    <div class="chart-img">
                        <img src="assets/images/chart-icon_1.png" class="img-fluid" alt="chart_icon">
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom chart_top">
                    <div class="chart-img">
                        <img src="assets/images/chart-icon_2.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 chart_top">
                    <div class="chart-img">
                        <img src="assets/images/chart-icon_3.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="chart-img">
                        <img src="assets/images/chart-icon_4.png" class="img-fluid" alt="chart_icon">
                    </div>
                    <div class="chart-text">
