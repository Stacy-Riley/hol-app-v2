                        ...
                        <div class="blog-title_block">
                            ...
                            <div class="blog-icons">
                                <div class="blog-share_block">
                                    <ul>
                                        <li><a href="https://www.linkedin.com/company/house-of-light-llc" aria-label="Follow us on LinkedIn"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.tiktok.com/@house_of_lightllc" aria-label="Follow us on Tiktok">
                                        ...
                                        <li><a href="https://www.instagram.com/house_of_lightllc/" aria-label="Follow us on Instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                                        <li><a href="https://www.facebook.com/houseoflightllc" aria-label="Follow us on Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                        <li> Share :</li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        @foreach($featuredPosts as $featuredPost)
                            <div class="featured-post-card">
                                ...
                                <div class="blog-featured-post-container-img">
                                    @if($isOldImage)
                                        <a href="{{ route('blog.show', $featuredPost->slug) }}" aria-label="Read more about {{ $featuredPost->title }}">
